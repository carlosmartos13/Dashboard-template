...
var enums_1 = require("./src/generated/prisma/enums");
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var email, senhaPlana, passwordHash, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    email = 'suporte@seatec.com.br';
                    senhaPlana = 'seatecsuporte';
                    return [4 /*yield*/, bcryptjs_1.default.hash(senhaPlana, 10)];
                case 1:
